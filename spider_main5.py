    ...
    def craw(self, times):
        ...
        while ii < times:
            ...
            if wiki_html_cont == None:
                noexistentries = open("noexistedentries5.txt", 'a', encoding='utf-8')
                ...
                baiduentries = open("baidu_result5.txt", 'a', encoding='utf-8')
                baiduentries.write(baidu_full_url)
                baiduentries.write('\n')
                baiduentries.close()
                wikientries = open("wiki_result5.txt", 'a', encoding='utf-8')
