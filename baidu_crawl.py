...
class SpiderMain(object):
    ...
    def craw(self):
        ...
        while i < count:
            ...
            baidu_new_titles, baidu_keyword_times, baidu_new_data, baidu_urls, titles_len, history_link, edits, pageviews, contributors_count, time2, all_len, category, reference_count, users, users_edits = self.baidu_parser.parse(urls[i], baidu_soup)
